      ...
      <div className="accordion" id="faqAccordion">
        {[
          ...
          },
          {
            ...
            answer:
              "بعد انتهاء الحجز، يمكنك الذهاب إلى صفحة \"الحجوزات\"، ثم اختيار الحجز المناسب والضغط على \"أضف تقييمًا\" لكتابة رأيك وتقييمك.",
          },
          {
            question: "هل يمكنني التواصل مع صاحب المنشأة؟",
            answer:
              "نعم، يمكنك التواصل مع صاحب المنشأة عبر معلومات الاتصال المعروضة في صفحة تفاصيل الملعب.",
          },
          {
            question: "هل أحتاج إلى دفع عبر الإنترنت؟",
            answer:
              "لا. يمكنك الدفع عند الوصول إلى الملعب، ولكن المنشآت قد توفر خيار الدفع عبر الإنترنت لتسهيل العملية.",
          },
